...
from sleep_classifiers.preprocessing.psg.psg_report_processor import PSGReportProcessor
...
class PSGService(object):
    ...
    def read_precleaned(subject_id):
        psg_path = str(Constants.DATA_PATH.joinpath('labels/' + subject_id + '_labeled_sleep.txt'))
        data = []
